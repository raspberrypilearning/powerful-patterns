...
I <span style="color: #0faeb0; font-weight:bold">requisiti del progetto</span> descrivono cosa deve restituire un progetto. È un po' come ricevere una missione da portare a termine.
</p>
...
<p style="border-left: solid; border-width:10px; border-color: #0faeb0; background-color: aliceblue; padding: 10px;">I modelli geometrici sono ovunque intorno a noi, nei tessuti, in natura, nell'arte, nelle tradizioni e nel design. Il punto di partenza di un modello è chiamato <span style="color: #0faeb0; font-weight:bold">motivo</span>, che è l'elemento che può essere ripetuto e disposto diversamente per creare diverse geometrie.
</p>
...
Puoi trovare il progetto Torta a strati Sarawak [qui](https://editor.raspberrypi.org/en/projects/repeated-patterns-example){:target="_blank"}
--- /task ---
...
</iframe> Puoi trovare il progetto Spirali [qui](https://editor.raspberrypi.org/en/projects/spirals-pattern-example){:target="_blank"}
...
</iframe> Puoi trovare il progetto Facce casuali [qui](https://editor.raspberrypi.org/en/projects/random-faces-example){:target="_blank"}
...
</iframe> Puoi trovare il progetto Art Déco [qui](https://editor.raspberrypi.org/en/projects/art-deco-example){:target="_blank"}
...
</iframe> Puoi trovare il progetto del tessuto Yakan [qui](https://editor.raspberrypi.org/en/projects/yakan-weaving-example){:target="_blank"}
...
![Completa il progetto Torta a strati Sarawak.](images/kek.png) Puoi trovare il progetto Torta a strati Sarawak qui https://editor.raspberrypi.org/en/projects/repeated-patterns-example ![Complete Spirals project.](images/spirals.png) Puoi trovare il progetto Spirali qui https://editor.raspberrypi.org/en/projects/spirals-pattern-example ![Complete Random faces project.](images/random_faces.png) Puoi trovare il progetto Facce casuali qui https://editor.raspberrypi. org/en/projects/random-faces-example ![Complete Art deco project.](images/art_deco.png) Puoi trovare il progetto Art Déco qui https://editor.raspberrypi.org/en/projects/art- deco-example ![Complete Yakan weaving project.](images/yakan.png) Puoi trovare il progetto del tessuto Yakan qui https://editor.raspberrypi.org/en/projects/yakan-weaving-example
