...
<p style="border-left: solid; border-width:10px; border-color: #0faeb0; background-color: aliceAZUL; padding: 10px;"><span style="color: #0faeb0">Abstração</span> é a solução de problemas reduzindo detalhes desnecessários. 
