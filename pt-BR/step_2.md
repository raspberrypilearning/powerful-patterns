...
Abra o [projeto inicial super padrões](https://editor.raspberrypi.org/en/projects/powerful-patterns-starter){:target=blank}. O editor de código será aberto em outra guia do navegador.
