...
def setup():
  ...
  global taille_carre
  taille_carre = int(input('Quelle taille de 🏴󠁧󠁢󠁳󠁣󠁴󠁿tartan souhaites-tu ? 20, 50 ou 100'))
  
def draw():
  
  lignes = 10 * frame_count # Utiliser la largeur/longueur de la forme pour animer dans le temps
