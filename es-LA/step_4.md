...
<p style="border-left: solid; border-width:10px; border-color: #0faeb0; background-color: alicedibujar_motivo; padding: 10px;"><span style="color: #0faeb0">Abstracción</span> es la resolución de problemas mediante la reducción de detalles innecesarios. 
